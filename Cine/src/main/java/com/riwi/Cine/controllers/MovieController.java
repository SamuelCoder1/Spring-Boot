package com.riwi.Cine.controllers;

import com.riwi.Cine.models.Movie;
import com.riwi.Cine.repositories.MovieRepository;
...
public class MovieController{
    ...
    public ResponseEntity<Movie> voteMovie (@PathVariable Integer id,@PathVariable double rating){
        if (!movieRepository.existsById(id)){
            return ResponseEntity.notFound().build();
        }
